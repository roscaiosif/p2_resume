...
var HTMLprojectImage = '<img src="%data%" class="img-responsive img-thumbnail project-img">';

var HTLMprojectCarouselIndicator = '<li data-target="#carousel-projects" data-slide-to=%data%></li>';
var HTLMprojectCarouselItem = '<div class="item %active%"><img src="%image%" alt="%alt%" class="img-slide"><div class="carousel-caption">%caption%</div></div>';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#">%data%';
var HTMLschoolDegree = ' - %data%</a><hr>';
...
var HTMLonlineSchool = ' - %data%</a><hr>';
